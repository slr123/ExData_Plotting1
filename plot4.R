...
with(hpcdata, plot(date, Voltage, xlab = "datetime", ylab = "Voltage", type = "n"))
with(hpcdata, lines(date, Voltage))
...
with(hpcdata, plot(date, Global_reactive_power, type = "n", xlab = "datetime"))
with(hpcdata, lines(date, Global_reactive_power))
